...
def get_balance_folder_and_type():
    ...
    if train_filename == "Bumble_train_balanced_generative.csv":
        return "Balanceado/Generative", "oversampling", "generative"

    if balancing_method == "oversampling":
        return "Balanceado/Smote", "oversampling", "smote"

    if balancing_method == "undersampling":
        return "Balanceado/Undersampling", "undersampling", "-"
...
def guardar_historial_experimento(gs, algorithm_name):
    ...
    _, balancing_method, tipo_oversampling = get_balance_folder_and_type()
...
def save_model(gs, algorithm_name):
    ...
    try:
        ...
        balance_folder, _, _ = get_balance_folder_and_type()
